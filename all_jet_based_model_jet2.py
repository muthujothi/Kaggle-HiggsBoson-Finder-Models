...
train_data = pd.read_csv('C:/LearningMaterials/Kaggle/HiggsBoson/training_jet2.csv')
...
data = pd.read_csv("C:/LearningMaterials/Kaggle/HiggsBoson/test_jet2.csv")
...
df.to_csv("predictions_jet2.csv", index=False, cols=["EventId", "Class", "SignalProb"])
